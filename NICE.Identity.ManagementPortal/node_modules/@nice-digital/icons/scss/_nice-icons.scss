...
/// @prop {string} check [f102] - <span class="icon icon--check" aria-hidden="true"></span>
...
@font-face {
  ...
  src: url($nice-font-base-path + "nice-icons.eot?" + $nice-icons-no-cache + "#iefix") format("embedded-opentype"),
